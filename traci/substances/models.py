...
class Hhcf(models.Model):
    ...
    #id = models.AutoField(primary_key=True)
    hhcf_urban_air_cancer = models.FloatField(blank=False, null=False, default=0)
    hhcf_urban_air_noncanc = models.FloatField(blank=False, null=False, default=0)
    hhcf_rural_air_cancer = models.FloatField(blank=False, null=False, default=0)
    hhcf_rural_air_noncanc = models.FloatField(blank=False, null=False, default=0)
