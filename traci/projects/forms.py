...
class ProjectForm(ModelForm):
    ...
    """
    # All strings except scope, which is a dropdown with choices.
    # Still a string, but w/ choices.
    # Project Name
    ...
    version = CharField(max_length=31,
                        ...
                        label=_("Project Version"),
                        required=True)
    # Organization
    organization = CharField(max_length=127,
                             widget=TextInput({
                                 'class': 'form-control mb-2',
                             ...
                             required=True)
    # Organizational Unit
    org_unit = CharField(max_length=63,
                         widget=TextInput({
                             'class': 'form-control mb-2',
    ...
    contact = CharField(max_length=127,
                        ...
                        required=True)
    # phone
    phone_num = CharField(max_length=31,
                          widget=TextInput({
                              'class': 'form-control mb-2',
                              'placeholder': '(###) ###-####'
                          }),
                          ...
                          required=True)
    # scope - dropdown
    scope = ChoiceField(choices=TRACI_SCOPE_OPTIONS,
                        widget=Select({
                            'class': 'form-control mb-2',
                        }),
                        label=_("Scope"),
    ...
    description = CharField(max_length=255,
                            ...
                            required=True)
    # functional unit
    functional_unit = CharField(max_length=31,
                                widget=Textarea({
                                    'rows': 1,
                                    'class': 'form-control mb-2',
                                    'placeholder': 'Unit'
                                }),
                                label=_("Functional Unit"),
                                required=True)
