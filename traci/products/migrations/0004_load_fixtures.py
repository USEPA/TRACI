...
fixture_filenames = ['lifecyclestagename.json', 'location.json', 'media.json']
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            "SELECT setval('products_lifecyclestagename_id_seq', max(id)) FROM products_lifecyclestagename;",
            migrations.RunSQL.noop),
        # migrations.RunSQL("SELECT setval('products_location_id_seq', max(id)) FROM products_location;", migrations.RunSQL.noop),
        migrations.RunSQL(
            "SELECT setval('products_media_id_seq', max(id)) FROM products_media;",
            migrations.RunSQL.noop),
