...
Available widgets:
- ListTextWidget allows the user to select from a dropdown or
                 optionally enter an option as free text.
"""
...
class ListTextWidget(forms.TextInput):
    """
    Custom widget to allow a user to select a dropdown option,
    or type in a custom option.
    """
